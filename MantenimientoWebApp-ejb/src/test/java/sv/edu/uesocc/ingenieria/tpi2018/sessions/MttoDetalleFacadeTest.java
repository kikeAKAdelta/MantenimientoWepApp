...
public class MttoDetalleFacadeTest {
    
    @Rule
    private EntityManagerProvider emp=new EntityManagerProvider();
    
    public MttoDetalleFacadeTest() {
    }
    ...
    /**
     * Test of create method, of class MttoDetalleFacade.
     */
    @Test
    public void testCreate() throws Exception {
        ...
        MttoDetalleFacade instance = new MttoDetalleFacade();
        ...
        MttoDetalle result = instance.create(entity);
    ...
    public void testEdit() throws Exception {
        ...
        MttoDetalle result = instance.edit(entity);
    ...
    public void testRemove() throws Exception {
        ...
        MttoDetalle result = instance.remove(entity);
    ...
    public void testFind() throws Exception {
        ...
        MttoDetalle expResult = new MttoDetalle();
        expResult.setIdMttoDetalle(1);
        assertNotNull(entity.getIdMttoDetalle());
        instance.create(entity);
        MttoDetalle result = instance.find(1);
    ...
    public void testFindAll() throws Exception {
        ...
        List<MttoDetalle> result = instance.findAll();
