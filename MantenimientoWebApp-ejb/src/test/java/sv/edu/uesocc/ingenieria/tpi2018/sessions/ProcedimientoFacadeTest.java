...
public class ProcedimientoFacadeTest {
    
     @Rule
    private EntityManagerProvider emp=new EntityManagerProvider();
     
    public ProcedimientoFacadeTest() {
    }
    ...
    /**
     * Test of create method, of class ProcedimientoFacade.
     */
     @Test
    public void testCreate() throws Exception {
        ...
        entity.setIdProcedimiento(1);
        entity.setDescripcion("procedimiento");
        ...
        ProcedimientoFacade instance = new ProcedimientoFacade();
        ...
        expResult.setDescripcion("procedimiento");
        
        Procedimiento result = instance.create(entity);
    ...
    public void testEdit() throws Exception {
        ...
        Procedimiento result = instance.edit(entity);
    ...
    public void testRemove() throws Exception {
        ...
        Procedimiento result = instance.remove(entity);
    ...
    public void testFind() throws Exception {
        ...
        expResult.setIdProcedimiento(1);
        expResult.setDescripcion("procedimiento");
        assertNotNull(entity.getIdProcedimiento());
        instance.create(entity);
        Procedimiento result = instance.find(1);
    ...
    public void testCrear() throws Exception {
        ...
        assertTrue(result);
        assertEquals(expResult, result);
        assertEquals("procedimiento", entity.getDescripcion());
    ...
    public void testFindAll() throws Exception {
        ...
        List<Procedimiento> result = instance.findAll();
