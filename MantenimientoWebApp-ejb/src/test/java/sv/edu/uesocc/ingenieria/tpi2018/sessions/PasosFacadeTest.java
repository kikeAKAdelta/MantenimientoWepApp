...
public class PasosFacadeTest {
    ...
    /**
     * Test of create method, of class PasosFacade.
     */
    @Test
    public void testCreate() throws Exception {
        ...
        PasosFacade instance = new PasosFacade();
        ...
        expResult.setDescripcion("pasos");
        
        Pasos result = instance.create(entity);
    ...
    public void testEdit() throws Exception {
        ...
        Pasos result = instance.edit(entity);
    ...
    public void testRemove() throws Exception {
        ...
        Pasos result = instance.remove(entity);
    ...
    public void testFind() throws Exception {
        ...
        expResult.setIdPasos(1);
        expResult.setDescripcion("pasos");
        assertNotNull(entity.getIdPasos());
        instance.create(entity);
        Pasos result = instance.find(1);
    ...
    public void testCrear() throws Exception {
        ...
        assertTrue(result);
        assertEquals(expResult, result);
        assertEquals("pasos", entity.getDescripcion());
