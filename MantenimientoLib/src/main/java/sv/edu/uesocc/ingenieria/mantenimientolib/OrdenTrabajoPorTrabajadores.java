...
public class OrdenTrabajoPorTrabajadores implements Serializable {
    ...
    public OrdenTrabajoPorTrabajadores(int idTrabajadores, int idOrdenTrabajo) {
        this.ordenTrabajoPorTrabajadoresPK = new OrdenTrabajoPorTrabajadoresPK(idTrabajadores, idOrdenTrabajo);
    }
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.mantenimientolib.OrdenTrabajoPorTrabajadores[ ordenTrabajoPorTrabajadoresPK=" + ordenTrabajoPorTrabajadoresPK + " ]";
    }
